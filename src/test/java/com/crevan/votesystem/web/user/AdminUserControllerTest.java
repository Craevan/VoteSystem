...
import static com.crevan.votesystem.web.user.AdminUserController.REST_URL;
import static com.crevan.votesystem.web.user.UserTestData.*;
...
class AdminUserControllerTest extends AbstractControllerTest {
    ...
    void getAll() throws Exception {
        perform(MockMvcRequestBuilders.get(REST_URL))
                .andExpect(status().isOk())
                .andExpect(content().contentTypeCompatibleWith(MediaType.APPLICATION_JSON))
                .andExpect(USER_MATCHER.contentJson(admin, guest, test, user));
    }
    ...
    void enable() throws Exception {
        ...
        assertFalse(userRepository.getExisted(USER_ID).isActive());
    }
    ...
    void createDuplicate() throws Exception {
        User expected = new User(null, "New", "newPass", USER_MAIL, Role.USER, Role.ADMIN);
        perform(MockMvcRequestBuilders.post(REST_URL)
                .contentType(MediaType.APPLICATION_JSON)
